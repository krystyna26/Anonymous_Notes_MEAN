...
module.exports = "<form (submit)=\"addNote()\">\n  Note:\n    <input \n    type=\"text\" \n    name=\"note\" \n    required \n    minlength=\"3\" \n    [(ngModel)]=\"note.message\" \n    #err='ngModel'>\n  Errors: {{ err.errors | json }}\n  Valid: {{ err.valid | json }}\n  \n  <input type=\"submit\" value=\"Add Note\" >\n</form>"
...
var AddComponent = (function () {
    function AddComponent(_noteService) {
    ...
    AddComponent.prototype.ngOnInit = function () {
        var _this = this;
        this._noteService.notes.subscribe(function (notes) { _this.notes = notes; });
    };
    AddComponent.prototype.addNote = function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__note_service__ = __webpack_require__("../../../../../src/app/note.service.ts");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_5__show_show_component__["a" /* ShowComponent */]
            ],
            imports: [
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_7__note_service__["a" /* NoteService */]],
...
var NoteService = (function () {
    function NoteService(_http) {
        this._http = _http;
        this.notes = new __WEBPACK_IMPORTED_MODULE_2_Rxjs__["BehaviorSubject"]([]);
    }
    NoteService.prototype.getNotes = function () {
        var _this = this;
        this._http.get('/show').subscribe(function (note) {
            console.log("getNotes: ", note.json());
            _this.notes.next(note.json());
        });
    };
    NoteService.prototype.addNote = function (new_message) {
        var _this = this;
        console.log('new_message added in addNote/service.ts', new_message);
        this._http.post("/add/" + new_message, new_message).subscribe(function (response) { _this.getNotes(); });
    };
...
module.exports = "<hr>\n<h1>This is coming from show component</h1>\n<p *ngFor=\"let note of notes\">{{ note.message }}</p>"
...
var ShowComponent = (function () {
    function ShowComponent(_noteService) {
        this._noteService = _noteService;
        this.notes = new __WEBPACK_IMPORTED_MODULE_2_Rxjs__["BehaviorSubject"]([]);
    }
    ShowComponent.prototype.ngOnInit = function () {
        var _this = this;
        this._noteService.notes.subscribe(function (response) {
